...
UCharismaTextboxController::UCharismaTextboxController()
{
}

void UCharismaTextboxController::UpdateTextboxesOnScreen()
{
...
void UCharismaTextboxController::UpdateTextboxesInScreenSpace()
{
	int32 totalCount = Positions.Num();

	// need player controller, as its 
...
FVector2D UCharismaTextboxController::FitPositionToViewport(FVector2D pendingPosition, FVector2D size, FVector2D viewportSize)
{
	// Reference
	// topleft = 0,0
	// bottomright = viewportsize (1600,900)
	...
	float minYLimit = size.Y / 2;
	float maxYLimit = ViewportSize.Y - size.Y / 2;
...
void UCharismaTextboxController::UpdateTextboxesOverlapping() 
{
...
FVector2D UCharismaTextboxController::GetNonCollidingPositionForTargetRect(FCharismaTextboxCollider targetRect, FCharismaTextboxCollider collidingRect, FVector2D& pushback, FVector2D& excess)
{
...
FVector2D UCharismaTextboxController::GetExcessOutsideOfBounds(FCharismaTextboxCollider targetRect)
{
...
bool UCharismaTextboxController::DoCollidersOverlap(FCharismaTextboxCollider colliderOne, FCharismaTextboxCollider colliderTwo) 
{
